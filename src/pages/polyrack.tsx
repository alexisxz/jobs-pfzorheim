...
export default function Boehmler() {
    const companyId: string = 'Hl3H0GE3ifBQgxW1Ashr'
    ...
    return (
        <>
            <Head>
                <title>Jobs by Polyrack</title>
                <meta name="description" content="Jobs by Polyrack GmbH" />
                ...
                <section style={{ marginBottom: '1rem' }} className={`${styles.section} ${styles.headingSection}`}>
                    <div className={styles.container}>
                        <div className={styles.homeHeader}>
                            <h1>Polyrack Jobs</h1>
                            <h5>Powered by <strong>Polyrack GmbH</strong></h5>
                            <Image src={PolyRackLogo} alt='Polyrack logo' className={styles.stirnerLogo} />
